import { VCLDateAdapter, VCLDateRange } from '../core';

export function compare<VCLDate>(adapter: VCLDateAdapter<VCLDate>, date1: VCLDate | VCLDate[] | VCLDateRange<VCLDate>, date2: VCLDate, scope: 'date' | 'month' | 'year'): boolean | 'range' | 'range-start' | 'range-end' | 'range-start-end' {
