...
import { VCLFormControlLabelModule, VCLButtonModule, VCLInputModule } from '@ng-vcl/ng-vcl';
...
export function demo() {
  return {
    ...
    tabs: {
      ...
      'README.md': {
        type: 'md',
        content: require('raw-loader!highlight-loader?!markdown-loader?breaks=true!../../../../lib/ng-vcl/src/form-control-label/README.md')
      },
      'demo.component.html': {
        type: 'pre',
