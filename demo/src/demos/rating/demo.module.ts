...
import {VCLRatingModule} from '@ng-vcl/ng-vcl/rating';
...
export function demo() {
  return {
    ...
    tabs: {
      ...
      'README.md': {
        type: 'md',
        content: require('raw-loader!highlight-loader?!markdown-loader?breaks=true!@ng-vcl/ng-vcl/rating/README.md')
      },
      'demo.component.html': {
        type: 'pre',
