...
/***/ "./demo/app/demos/jss-form/custom-sample.component.ts":
/*!************************************************************!*\
  !*** ./demo/app/demos/jss-form/custom-sample.component.ts ***!
  \************************************************************/
/*! exports provided: CustomSampleComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CustomSampleComponent", function() { return CustomSampleComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var CustomSampleComponent = /** @class */ (function () {
    function CustomSampleComponent() {
        this.message = '';
        this.disabled = false;
        this._counter = 0;
    }
    Object.defineProperty(CustomSampleComponent.prototype, "counter", {
        get: function () {
    ...
    CustomSampleComponent.prototype.increment = function () {
        this.counter++;
    };
    CustomSampleComponent.prototype.decrement = function () {
        this.counter--;
    };
    CustomSampleComponent.prototype.writeValue = function (value) {
        this._counter = value;
    };
    CustomSampleComponent.prototype.registerOnChange = function (fn) {
        this.onChangeCallback = fn;
    };
    CustomSampleComponent.prototype.registerOnTouched = function (fn) {
        this.onTouchedCallback = fn;
    };
    CustomSampleComponent.prototype.setDisabledState = function (isDisabled) {
        this.disabled = isDisabled;
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], CustomSampleComponent.prototype, "message", void 0);
    CustomSampleComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
module.exports = "<h2>Create a hero</h2>\n<vcl-jss-form \n  #heroForm=\"vclJssForm\"\n  [schema]=\"heroSchema\" \n  (formSubmit)=\"onSubmit($event, heroForm.formGroup.valid)\" \n  (formAction)=\"onAction($event)\">\n</vcl-jss-form>\n\n<div class=\"value\">\n  <h4>Form</h4>\n  <pre>status: {{ heroForm.formGroup.status }}</pre>\n  <pre>valid: {{ heroForm.formGroup.valid }}</pre>\n  <pre>dirty: {{ heroForm.formGroup.dirty }}</pre>\n  <pre>submitted: {{ heroForm.formGroup.submitted }}</pre>\n  <pre>touched: {{ heroForm.formGroup.touched }}</pre>\n  <pre>pristine: {{ heroForm.formGroup.pristine }}</pre>\n  <pre>errors: {{ heroForm.formGroup.errors | json }}</pre>\n  <pre>value: {{ heroForm.formGroup.value | json }}</pre>\n</div>\n"
...
var JssFormDemoComponent = /** @class */ (function () {
    ...
    JssFormDemoComponent.prototype.onSubmit = function (value, valid) {
    ...
    JssFormDemoComponent.prototype.onAction = function (action) {
        if (action === 'reset' && this.heroForm.formGroup) {
            ...
            //   text: `Hero rejected`
            // });
            this.heroForm.formGroup.reset(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _hero__WEBPACK_IMPORTED_MODULE_2__["HERO_DEFAULTS"]));
        }
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _custom_sample_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./custom-sample.component */ "./demo/app/demos/jss-form/custom-sample.component.ts");
    ...
    return {
        ...
        tabs: {
            ...
            'custom-sample.component.ts': {
                type: 'pre',
                content: __webpack_require__(/*! highlight-loader?raw=true&lang=ts!./custom-sample.component.ts */ "./node_modules/highlight-loader/index.js?raw=true&lang=ts!./demo/app/demos/jss-form/custom-sample.component.ts")
            },
            'hero.ts': {
                type: 'pre',
...
var VCLJssFormDemoModule = /** @class */ (function () {
    ...
    VCLJssFormDemoModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            entryComponents: [_demo_component__WEBPACK_IMPORTED_MODULE_7__["JssFormDemoComponent"], _custom_sample_component__WEBPACK_IMPORTED_MODULE_8__["CustomSampleComponent"]],
            declarations: [_demo_component__WEBPACK_IMPORTED_MODULE_7__["JssFormDemoComponent"], _custom_sample_component__WEBPACK_IMPORTED_MODULE_8__["CustomSampleComponent"]]
        })
...
module.exports = "<span class=\"hljs-keyword\">import</span> { Component, OnInit, ViewChild } <span class=\"hljs-keyword\">from</span> <span class=\"hljs-string\">'@angular/core'</span>;\n<span class=\"hljs-keyword\">import</span> { HERO_SCHEMA, HERO_DEFAULTS } <span class=\"hljs-keyword\">from</span> <span class=\"hljs-string\">'./hero'</span>;\n<span class=\"hljs-keyword\">import</span> { JssFormComponent } <span class=\"hljs-keyword\">from</span> <span class=\"hljs-string\">'@ng-vcl/ng-vcl'</span>;\n\n\n<span class=\"hljs-meta\">@Component</span>({\n  templateUrl: <span class=\"hljs-string\">'demo.component.html'</span>\n})\n<span class=\"hljs-keyword\">export</span> <span class=\"hljs-keyword\">class</span> JssFormDemoComponent {\n\n  <span class=\"hljs-keyword\">constructor</span>(<span class=\"hljs-params\"></span>) { }\n\n  <span class=\"hljs-meta\">@ViewChild</span>(<span class=\"hljs-string\">'heroForm'</span>)\n  heroForm: JssFormComponent;\n\n  heroSchema = HERO_SCHEMA;\n\n  value = {...HERO_DEFAULTS};\n\n  onSubmit(value, valid) {\n    <span class=\"hljs-built_in\">console</span>.log(<span class=\"hljs-string\">'value'</span>, value);\n\n    <span class=\"hljs-keyword\">if</span> (valid) {\n      <span class=\"hljs-comment\">// this.ns.success({</span>\n      <span class=\"hljs-comment\">//   text: `${value.name} is a valid hero`</span>\n      <span class=\"hljs-comment\">// });</span>\n    } <span class=\"hljs-keyword\">else</span> {\n      <span class=\"hljs-keyword\">if</span> (<span class=\"hljs-keyword\">this</span>.heroForm.formGroup) {\n        <span class=\"hljs-comment\">// markAsDeeplyTouched(this.heroForm.formGr);</span>\n      }\n      <span class=\"hljs-comment\">// this.ns.error({</span>\n      <span class=\"hljs-comment\">//   text: `Your hero is not valid`</span>\n      <span class=\"hljs-comment\">// });</span>\n    }\n  }\n\n  onAction(action: <span class=\"hljs-built_in\">string</span>) {\n    <span class=\"hljs-keyword\">if</span> (action === <span class=\"hljs-string\">'reset'</span> &amp;&amp; <span class=\"hljs-keyword\">this</span>.heroForm.formGroup) {\n      <span class=\"hljs-comment\">// this.ns.warning({</span>\n      <span class=\"hljs-comment\">//   text: `Hero rejected`</span>\n      <span class=\"hljs-comment\">// });</span>\n      <span class=\"hljs-keyword\">this</span>.heroForm.formGroup.reset({...HERO_DEFAULTS});\n    }\n  }\n\n}\n"
