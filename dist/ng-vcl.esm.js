import { EventEmitter, NgModule, Input, ChangeDetectionStrategy, Component, Injectable, OpaqueToken, Inject, Optional, Pipe, HostBinding, Output } from '@angular/core';
...
L10nStaticLoaderService = class L10nStaticLoaderService extends L10nLoaderService {
    constructor(config) {
        super();
        this.config = config;
    }
...
L10nNoopLoaderService = class L10nNoopLoaderService extends L10nLoaderService {
    getTranslationPackage(locale) {
        return Observable.of({});
    }
};
...
L10nFormatParserService = class L10nFormatParserService extends L10nParserService {
    parse(value, ...args) {
...
let L10nModule_1;
L10nModule = L10nModule_1 = class L10nModule {
...
VCLIconModule = class VCLIconModule {
};
...
VCLIcogramModule = class VCLIcogramModule {
};
...
VCLButtonModule = class VCLButtonModule {
};
